...
class Smart_SEO_Tool_Admin {
    ...
    public static function set_guide()
    {
        if( isset($_POST['opt']) && is_array($_POST['opt']) ){
            update_option('sseot_guide',$_POST['opt'],false);
	...
	public function admin_enqueue_scripts( $hook ) {
		...
		wp_add_inline_script('wbsst-inline-js',' var wb_cnf='.json_encode($wb_cnf,JSON_UNESCAPED_UNICODE).';','before');
